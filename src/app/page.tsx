  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-20 p-24">
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="bg-gradient-to-Pt fixed bottom-0 left-0 flex h-48 w-full items-end justify-center from-white via-white lg:static lg:size-auto lg:bg-none dark:from-black dark:via-black">
          <a
