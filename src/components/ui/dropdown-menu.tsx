...
// Additional DropdownMenu components for customization
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-gray-100',
      className,
    )}
    checked={checked}
    {...props}
...
// Exporting all the components for easy use
export {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
